...
__decorate([
    core_1.Input()
], OurpalmTableDynamicColumnComponent.prototype, "column");
__decorate([
    core_1.Input()
], OurpalmTableDynamicColumnComponent.prototype, "index");
__decorate([
    core_1.Input()
], OurpalmTableDynamicColumnComponent.prototype, "row");
__decorate([
    core_1.Input()
], OurpalmTableDynamicColumnComponent.prototype, "table");
